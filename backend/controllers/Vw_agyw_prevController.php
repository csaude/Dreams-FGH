...
public function actionIndex()
{
    ...
    public function actionCompletude($dataInicio,$dataFim)
    {
        ...
        $i = 0;
        $query = "select beneficiario_id, faixa_actual, vai_escola, sexualmente_activa,
                    sum(case
                ...
                group by beneficiario_id, faixa_actual, vai_escola, sexualmente_activa";
        ...
        $completudeResults = array(
            'completaram_apenas_pacote_primario' => array($completaram_pacote_primario),
        );

        Yii::$app->response->format = Response::FORMAT_JSON;
        return $this->asJson($completudeResults);
    ...
    function completude($dataInicio,$dataFim){
        ...
        $completudeResults = array(
            'completaram_pacote_primario' => array($completaram_pacote_primario),
            'completaram_servico_primario' => array($completaram_servico_primario),
            'completaram_servico_secundario' => array($completaram_servico_secundario),
            'completaram_servico_violencia' => array($completaram_servico_violencia),
            'tiveram_intervencao_subsidio_escolar' => array($tiveram_intervencao_subsidio_escolar)
        );
    ...
    public function actionIndicator($dataInicio,$dataFim){
        ...
        $completaram_pacote_primario = $this->completude($dataInicio,$dataFim);

        $primario=ArrayHelper::getValue($completaram_pacote_primario,'completaram_pacote_primario');
        $primario=ArrayHelper::getValue($completaram_pacote_primario,'completaram_pacote_primario');
