...
<?=  $form->field($model, 'deficiencia_tipo')->widget(Select2::classname(), ['data' => ['' => '--Tipo de Deficiência--','Fisica' => 'Fisica', 'Mental' => 'Mental'],
 ])->label(false); ?>
 </div>
...
<a href="#" data-toggle="tooltip" data-placement="top" title="Hooray!">
    <span class="glyphicon glyphicon-info-sign" aria-hidden="true"  data-toggle="tooltip" data-placement="top" title="Hooray!"></span> </a>
    <a class="btn btn-danger" data-toggle="collapse" href="#elegibilidade" aria-expanded="false" aria-controls="elegibilidade"  data-placement="top" title="Hooray!">Critérios de Eligibilidade Específicos</a></b>
  </div>
  <div class="panel-body">

<div class="collapse" id="elegibilidade">
<table>
  <tr> <td align="right" width="60%"> Vítima de Exploração sexual?</td> <td width="10%">&nbsp;</td><td>&nbsp;<?=  $form->field($model, 'vbg_exploracao_sexual')->widget(Select2::classname(),['data' => ['0' => 'Não','1' => 'SIM'],'options' => ['placeholder' => '--Selecione Aqui--'],'pluginOptions' => ['allowClear' => true],])->label(false); ?></td></tr>
  ...
  <tr> <td align="right">Sexualmente Activa?</td><td>&nbsp;</td><td>&nbsp;<?=  $form->field($model,'vbg_sexual_activa')->widget(Select2::classname(),['data' => ['0' => 'Não','1' => 'SIM'],'options' => ['placeholder' => '--Selecione Aqui--'],'pluginOptions' => ['allowClear' => true],
   ])->label(false); ?></td></tr>
