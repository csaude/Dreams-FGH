...
class Beneficiarios extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['emp_birthday','district_code','emp_lastname','emp_firstname', 'emp_gender', 'provin_code','ponto_entrada','bairro_id','encarregado_educacao', 'membro_localidade_id','orphan'], 'required'],
